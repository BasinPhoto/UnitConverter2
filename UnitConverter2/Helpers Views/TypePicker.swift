...
struct TypePicker: View {
    ...
    var body: some View {
        ...
        ZStack {
                        ...
                        Button {
                            ...
                            if toVar == keyNumber {
                                Text(unit.keysArray[keyNumber])
                                    ...
                                    .clipShape(Capsule())
                                    .padding(.horizontal)
                                    .shadow(color: backgroundColor.opacity(0.7), radius: 10, x: 0, y: 0)
                            } else {
                                Text(unit.keysArray[keyNumber])
            ...
            VStack {
                LinearGradient(gradient: Gradient(colors: [backgroundColor, backgroundColor.opacity(0)]), startPoint: .top, endPoint: .bottom)
                    .frame(height: 40)
                    .ignoresSafeArea()
                    .disabled(true)
                Spacer()
